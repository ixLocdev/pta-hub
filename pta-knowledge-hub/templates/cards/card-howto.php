<?php
/**
 * Card template: How-To Guide
 * Blue accent, steps preview, "Read Steps" link.
 *
 * Variables: $result (array with id, title, excerpt, permalink, thumbnail, tags)
 */
?>
<a href="<?php echo esc_url( $result['permalink'] ); ?>" class="ptk-card ptk-card-howto">
    ...
    <div class="ptk-card-body">
        <span class="ptk-card-badge ptk-badge-howto">How-To Guide</span>
        ...
        <?php endif; ?>
        <span class="ptk-card-link ptk-link-howto">Read Steps &rarr;</span>
    </div>
</a>
