<?php
/**
 * Card template: Policy / Rules
 * Slate/gray accent, policy title, plain-English summary.
 *
 * Variables: $result (array with id, title, excerpt, permalink, thumbnail, tags)
 */
?>
<div class="ptk-card ptk-card-policy">
    <div class="ptk-card-body">
        <div class="ptk-card-header">
            <span class="ptk-card-badge ptk-badge-policy">Policy</span>
        </div>
        ...
        <?php endif; ?>
        <a href="<?php echo esc_url( $result['permalink'] ); ?>" class="ptk-card-link ptk-link-policy" aria-hidden="true" tabindex="-1">Read Policy &rarr;</a>
    </div>
</div>
